...
| macOS and Windows package authenticity | IA-5, SC-12, SA-10, SI-7 | CC6.6, CC8.1 | A.8.24, A.8.29 | CIS Controls 2, 4 | Apple Developer ID certificate, notarization output, Authenticode certificate, verification command output | Gap: enterprise desktop signing and notarization evidence is not present in the reviewed workflows. |
...
| Security testing and vulnerability management | RA-5, SI-2, SA-11, SA-15, CM-6 | CC7.1, CC7.2, CC8.1 | A.8.8, A.8.25, A.8.28, A.8.29 | CIS Controls 7, 16 | `make release-security-scan`, optional scanner outputs, SBOM, dependency inventory, SAST, shell lint, Dockerfile lint, systemd review | Partial: Make targets and evidence templates exist, but reviewed workflows do not run them as required publication gates and critical/high blocking thresholds are not defined in source. |
